...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        //begin modify xuy on 2015-09-09
...
//        setUpdateByPrimaryKeyStatementId("updateByPrimaryKey"); //$NON-NLS-1$
        setUpdateByPrimaryKeyStatementId("updateAllById"); //$NON-NLS-1$
...
//        setBaseColumnListId("Base_Column_List"); //$NON-NLS-1$
        ...
        setSelectSelectiveStatementId("selectByPage"); //$NON-NLS-1$
        //end modify xuy on 2015-09-09
    }
    ...
    protected void calculateJavaClientAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        //begin modify by xuy on 2015-09-09
//        sb.append("Mapper"); //$NON-NLS-1$
        sb.append("Dao"); //$NON-NLS-1$
      	//end modify by xuy on 2015-09-09
