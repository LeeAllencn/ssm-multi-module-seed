...
//                .calculateAllFieldsClass();
        FullyQualifiedJavaType returnType = new FullyQualifiedJavaType(introspectedTable.getRules()
              .calculateAllFieldsClass() + "Vo");
        returnType.setBaseQualifiedName(returnType.getBaseQualifiedName().replace("entity", "vo"));
        returnType.setPackageName(returnType.getPackageName().replace("entity", "vo"));
