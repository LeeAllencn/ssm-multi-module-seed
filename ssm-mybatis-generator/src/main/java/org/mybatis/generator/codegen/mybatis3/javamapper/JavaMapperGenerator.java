...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
    	...
    	if (introspectedTable.getFullyQualifiedTable().getRemarks() != null && !"".equals(introspectedTable.getFullyQualifiedTable().getRemarks())) {
    		interfaze.addJavaDocLine(" * 表描述：" + introspectedTable.getFullyQualifiedTable().getRemarks());
		}
    	interfaze.addJavaDocLine(" * ");
    	interfaze.addJavaDocLine(" * @author WengKai");
    	interfaze.addJavaDocLine(" * @version 1.0 " + sdf.format(new Date()));
    	interfaze.addJavaDocLine(" */");
