...
public class UpdateByPrimaryKeySelectiveElementGenerator extends
    ...
    public void addElements(XmlElement parentElement) {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable
            ...
            if("VARCHAR".equals(introspectedColumn.getJdbcTypeName())||"CHAR".equals(introspectedColumn.getJdbcTypeName())||"VARCHAR2".equals(introspectedColumn.getJdbcTypeName())||"NVARCHAR2".equals(introspectedColumn.getJdbcTypeName())){
